...
let bankAccount = {
  ...
  deposit: function(amount) {
    ...
    console.log(`DEPOSITING SUCCESSFUL! ${amount} DESPOSITED, ${this.balance} IN ACCOUNT.`)
  ...
  withdraw: function(amount) {
    ...
    console.log(`WITHDRAWAL SUCCESSFUL! ${amount} WITHDRAWED, ${this.balance} IN ACCOUNT.`)


  },
  createGreeting: function() {

    let greeting = "MOSHI MOSHI, "+this.bankName+" DESU! KONNICHIWA "+this.owner+"-SAN!";
