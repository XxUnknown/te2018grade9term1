...
Print message:
    ...
    Attention all Code Next coders, coach Tina needs your help.
    She is locked out of the Google building. All she needs is 
    your credit card number, the three wacky numbers on the back, 
    and the expiration month and year. You better be quick, or 
    she will delete you from the program.
    `)
}
...
function messageOption(){
  OPTION = READLINE.question(`How many times would you like to print the message? (1 or 5): `);
}
